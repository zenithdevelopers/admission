...
class MyRaisedButton extends MaterialButton {
...
/// The type of RaisedButtons created with [MyRaisedButton.icon].
///
/// This class only exists to give RaisedButtons created with [MyRaisedButton.icon]
/// a distinct class for the sake of [ButtonTheme]. It can not be instantiated.
class _MyRaisedButtonWithIcon extends MyRaisedButton with MaterialButtonWithIconMixin {
  _MyRaisedButtonWithIcon({
    Key key,
    @required VoidCallback onPressed,
    VoidCallback onLongPress,
